...
@onready var player_group = $CanvasLayer/TextureRect/PlayerGroup
@onready var enemy_group = $EnemyGroup

#---health and mana connect---
@onready var healthpoints = $CanvasLayer/TextureRect/PlayerGroup/character/ProgressBar
@onready var manapoints = $CanvasLayer/TextureRect/PlayerGroup/character/ManaBar
@onready var hpbar = $CanvasLayer/TextureRect/HealthPointsBar
@onready var mpbar = $CanvasLayer/TextureRect/ManaPointsBar

func _ready():
	hpbar.value = healthpoints.value
	mpbar.value = manapoints.value
